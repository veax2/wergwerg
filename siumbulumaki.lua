...
local Window = Library:CreateWindow("Aura X Remake", Vector2.new(300, 300), Enum.KeyCode.RightShift)
local AkaliNotif =
...
testSection:AddButton("sigma", function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(218.23658752441406, 3.737133026123047, -331.1084899902344, -1, 0, 0, 0, 1, 0, 0, 0, -1)
end)
